    ...
    Tables: {
      ...
      commune_risk_profiles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "commune_risk_profiles_model_version_id_fkey"
          ...
          {
            foreignKeyName: "commune_risk_profiles_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
            referencedRelation: "data_sources"
            referencedColumns: ["id"]
      ...
      risk_model_coefficients: {
        ...
        Relationships: [
          {
            foreignKeyName: "risk_model_coefficients_model_version_id_fkey"
            columns: ["model_version_id"]
            isOneToOne: false
            referencedRelation: "risk_model_versions"
            referencedColumns: ["id"]
      ...
      risk_time_windows: {
        ...
        Relationships: [
          {
            foreignKeyName: "risk_time_windows_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
            referencedRelation: "data_sources"
            referencedColumns: ["id"]
